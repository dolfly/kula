...
```bash
wget https://github.com/c0m4r/kula/releases/download/0.18.5/kula-0.18.5-x86_64.rpm
echo "02f38e03d78df6be80f2fa3517ef95564ff8d0ce04a846b2ff2f16f3bef089c5 kula-0.18.5-x86_64.rpm" | sha256sum -c || rm -f kula-0.18.5-x86_64.rpm
sudo rpm -i kula-0.18.5-x86_64.rpm
journalctl -f -t kula
```
